      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            Recent Mathematics graduate with ISTQB Software Testing Foundation
            Qualification, SAS and CS50 certifications, and hands-on experience
            with Typescript, JavaScript and React for building progressive web
            applications. With a proven ability to engage with clients and a
